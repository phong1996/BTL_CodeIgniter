<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                <form class="form-horizontal" action="<?php echo url_admin('Technews/postAdd'); ?>" enctype="multipart/form-data" method="post" id="frm-news-add">
                    <div class="row clearfix">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <textarea name="content" required id="content" cols="30" rows="10"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="file" accept="image/*" name="images" id="images"  required class="form-control" placeholder="Enter your image">
                                </div>
                            </div>
                        </div>
                    </div>
